...
public class Settings extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if(isChecked){
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ContextCompat.startForegroundService(Settings.this, intent);
                    } else {
                        startService(intent);
                    }
                    Toast.makeText(Settings.this, "백그라운드 측정을 시작합니다.", Toast.LENGTH_SHORT).show();

                } else {
                    //체크되어있지 않으면 아무런 측정도 X, 이미 체크되어있었다면 백그라운드 중지
                    Intent intent = new Intent(Settings.this, ForegroundService.class);
                    stopService(intent);
                    Toast.makeText(Settings.this, "백그라운드 측정을 종료합니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        updateTimeText();
        AlarmSetting.setRepeating(Settings.this, startHour, startMinute, "com.example.soundwatch.START_MEASUREMENT");
        AlarmSetting.setRepeating(Settings.this, stopHour, stopMinute, "com.example.soundwatch.STOP_MEASUREMENT");
